...
To = 298
Po = ct.one_atm
directory = '/work/westgroup/nora/Code/projects/Burgess_Comments/2_BTP_optimization/models/NIST/2-BTP_kinetics_originally_no_M.cti'
...
for i in  range(len(BTPmole_list)):
    try: 
        ...
        vol_frac_dict = {'CH4': 0.5, 'O2': 1, 'N2': 3.76, 'BTP': x }
        ...
        print(vol_frac_dict)
        print(f"O2/CH4 ratio = {vol_frac_dict['O2']/vol_frac_dict['CH4']}. Complete combustion takes 2")
...
#                 print(' initial guess has been set')
        ...
        df1.to_csv(f'no_M_{x}.csv', index=False)
