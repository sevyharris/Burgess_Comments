...
To = 298
Po = ct.one_atm
directory = '/work/westgroup/nora/Code/projects/Burgess_Comments/2_BTP_optimization/models/RMG_with_BROH/chemkin/copies/copy_chem0204.cti'
...
#                 print(' initial guess has been set')
        ...
        df1.to_csv(f'{x}_182.csv', index=False)
...
with open(f'flame_speeds_182.csv', 'w+') as g:
    g.write(directory)
    g.write('\n')
