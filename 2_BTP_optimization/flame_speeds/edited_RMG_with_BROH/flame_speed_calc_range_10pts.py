...
To = 298
Po = ct.one_atm
directory = '/work/westgroup/nora/Code/projects/Burgess_Comments/2_BTP_optimization/models/edited_RMG_with_BROH/edited_RMG_with_BROH_777.cti'
...
#                 print(' initial guess has been set')
        ...
        df1.to_csv(f'{x}_777.csv', index=False)
...
with open(f'flame_speeds_777.csv', 'w+') as g:
    g.write(directory)
    g.write('\n')
