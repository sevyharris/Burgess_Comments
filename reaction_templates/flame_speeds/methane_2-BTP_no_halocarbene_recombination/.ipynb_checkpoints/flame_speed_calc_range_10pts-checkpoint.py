...
To = 298
Po = ct.one_atm
directory = '/work/westgroup/nora/Code/projects/Burgess_Comments/reaction_templates/flame_speeds/methane_2-BTP_no_halocarbene_recombination/no_HR_chem_annotated.cti'
...
with open(f'final_speeds.csv', 'w+') as g:
    g.write(directory)
    g.write('\n')
